...
app.config["JWT_SECRET_KEY"] = (
    "PsOYhIGbnwgDIsu5xnm+BXKfkaFjivYsafkLnGkL7TA="  # Cambia esta clave por una más segura
)
jwt = JWTManager(app)
        ...
        "clases": [
            {
                ...
                "video": "https://www.youtube.com/watch?v=TlJbu0BMLaY&t=9s",
    ...
    },
    {
        ...
        "clases": [
            ...
            },
            {
                ...
                "video": "https://www.youtube.com/watch?v=TlJbu0BMLaY&t=9s4",
...
def login():
    ...
    if username != "eichtici" or password != "12345678":
