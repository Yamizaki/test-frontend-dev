...
const Login = ({ callback }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen max-h-[900px] px-2 animate-fade-in-scale">
      <div className="w-full max-w-md bg-slate-800 rounded-lg shadow-md p-6 text-white">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col">
          ...
          <div className="flex items-center justify-between flex-wrap">
            <span className="text-sm text-blue-400 hover:underline">¿Olvidaste tu contraseña?</span>
            <p className="mt-4"> ¿ No tienes una cuenta ? <span className="text-sm text-blue-400 -200 hover:underline mt-4">Regístrate</span></p>
          </div>
